...
mlflow.set_experiment("MLflow Tutorial - Alternative Model 1")
...
with mlflow.start_run():
    ...
    mlflow.set_tag("Training Info", "Alternative Model 1 - Decision Tree Classifier for Iris Flower Dataset")
    ...
    model_info = mlflow.sklearn.log_model(
        sk_model=clf,
        artifact_path="alternative_model_1",
        signature=signature,
        input_example=X_train,
        registered_model_name="alternative_model_1"
    )
