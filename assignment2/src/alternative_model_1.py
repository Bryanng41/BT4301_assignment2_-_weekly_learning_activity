"""Alternative 1: Random Forest on classification event table."""
...
if __name__ == "__main__":
    ...
    mlflow.set_experiment("Assignment2 - Alternative Model 1")
    with mlflow.start_run():
        ...
        log_sklearn_pipeline_model(
            ...
            registered_model_name="assignment2_alt1_rf",
        )
        mlflow.log_metric("accuracy", acc)
        mlflow.log_metric("precision", prec)
        mlflow.log_metric("recall", rec)
        mlflow.log_metric("f1", f1)
        mlflow.set_tag("Training Info", "Random forest + OHE/scale (purchase yes/no)")
