"""Alternative 2: XGBoost on classification event table."""
...
if __name__ == "__main__":
    ...
    mlflow.set_experiment("Assignment2 - Alternative Model 2")
    with mlflow.start_run():
        ...
        log_sklearn_pipeline_model(
            ...
            registered_model_name="assignment2_alt2_xgb",
        )
        mlflow.log_metric("accuracy", acc)
        mlflow.log_metric("precision", prec)
        mlflow.log_metric("recall", rec)
        mlflow.log_metric("f1", f1)
        mlflow.set_tag("Training Info", "XGBoost + OHE/scale (purchase yes/no)")
